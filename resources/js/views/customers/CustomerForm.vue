...
export default {
    ...
    setup() {
        ...
        const handleSubmit = async () => {
            ...
            try {
                if (isEditMode.value) {
                    await customerStore.updateCustomer(route.params.id, formData);
                    success.value = 'Cliente actualizado exitosamente';
                } else {
                ...
                error.value = customerStore.error || 'Error al guardar el cliente';
            } finally {
                loading.value = false;
            }
        };
